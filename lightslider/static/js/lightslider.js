...
$(function () {
	...
	function LightSliderPluginViewModel(parameters) {
		...
		self.settings.pinTitle = ko.observable(gettext("Set the GPIO Pin you want to use for the pwm signal."));
		self.settings.clockTitle = ko.observable(gettext("Set the PWM switching frequency you want to use."));
		...
		self.updateSettings = function () {
			try {
				self.settings.minIntensity(parseInt(self.settings.settings.plugins.lightslider.minIntensity()));
				self.settings.maxIntensity(parseInt(self.settings.settings.plugins.lightslider.maxIntensity()));
				self.settings.notifyDelay(parseInt(self.settings.settings.plugins.lightslider.notifyDelay()));
				self.settings.pwmPin(parseInt(self.settings.settings.plugins.lightslider.pwmPin()));
				self.settings.pwmClock(parseInt(self.settings.settings.plugins.lightslider.pwmClock()));
			}
			catch (error) {
				console.log(error);
			}
		...
		self.onBeforeBinding = function () {
			self.settings.defaultIntensity(parseInt(self.settings.settings.plugins.lightslider.defaultIntensity()));
			self.updateSettings();
